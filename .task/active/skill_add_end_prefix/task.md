...
- [x] 4. KB: `.Knowledge/topics/ctrip-train-d2c.md` 新增第 8 段"end- 逆向布局(v0.3.2 新增)" + 关键前缀清单补 end- 一条;`.Knowledge/index.md` topic overview 表 ctrip-train-d2c 行补 end-;`.Knowledge/matchers/m-ctrip-train-d2c.json` 加 12 个 end- 相关关键词。stock-docs 跳过(topic 已充分)。manifest-routing.json 不变。
