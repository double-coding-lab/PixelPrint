...
| ctrip-train-d2c | `.Knowledge/topics/ctrip-train-d2c.md` | D2C 主 SKILL 的执行约定、图层前缀体系（sub-/img-/bg-/bgc-/fixed- 等）、图片导出参数、scroll 容器规则、token 兜底链与避坑 | SKILL: `templates/skills/ctrip-train-d2c/SKILL.md`; 关联: [[ctrip-train-d2c-doctor]] |
